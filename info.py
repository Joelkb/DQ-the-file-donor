...
BOT_TOKEN = environ.get('BOT_TOKEN', "6263623615:AAGss1_3S1VnfnaYwB9vbx_56d0AYtB-GmI")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Max:Max@max.sfxacmv.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Max")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001765544203'))
