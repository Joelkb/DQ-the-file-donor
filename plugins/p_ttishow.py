...
from Script import script, MELCOW_ENG, MELCOW_MAL
...
async def mcb_handler(bot, query: CallbackQuery):
    if query.data == "melcow_eng":
        ...
        await query.message.edit_text(
            text=(MELCOW_ENG.format(query.from_user.mention, message.chat.title)),
            reply_markup=reply_markup,
            parse_mode='html'
        )
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=(MELCOW_MAL.format(query.from_user.mention, message.chat.title)),
            reply_markup=reply_markup,
            parse_mode='html'
        )
