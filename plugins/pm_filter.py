...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        ...
        InlineKeyboardButton("Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ", url="https://t.me/how_to_download67/2")
    ])
    btn.insert(0, [
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Susil25_movie")
                             ]
                            ]
                        )
                    )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Susil25_movie")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
