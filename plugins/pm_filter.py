...
from Script import script, ALRT_TXT, OLD_ALRT_TXT, CUDNT_FND, I_CUDNT, I_CUD_NT, MVE_NT_FND, TOP_ALRT_MSG, OWNER_INFO, URL
import pyrogram
    ...
    if not movielist:
        k = await msg.reply_text(
            ...
            reply_markup = InlineKeyboardMarkup(
             [[
                InlineKeyboardButton("Check Spelling On Google ✅", url=(URL.format(query)))
             ]]
            )
        )
        await asyncio.sleep(8)
